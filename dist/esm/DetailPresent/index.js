...
export var DetailPresent = function DetailPresent(_ref) {
  ...
  return /*#__PURE__*/ _jsx(
    Descriptions,
    _objectSpread(
      _objectSpread({}, descriptionProps),
      {},
      {
        children: keys.map(function (key) {
          var _detail$key;

          var itemConfig = _objectSpread(
            _objectSpread(
              {},
              (keyMapItemProps === null || keyMapItemProps === void 0
                ? void 0
                : keyMapItemProps[key]) || {},
            ),
            {},
          ...
          return (
            ...
            /*#__PURE__*/ _jsx(
              Descriptions.Item,
              _objectSpread(
                _objectSpread({}, itemConfig),
                {},
                {
                  children: /*#__PURE__*/ _jsx(_Fragment, {
                    children:
                      (_detail$key = detail[key]) !== null && _detail$key !== void 0
                        ? _detail$key
                        : placeholder,
                  }),
                },
