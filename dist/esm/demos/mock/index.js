...
export var getData = /*#__PURE__*/ (function () {
  var _ref = _asyncToGenerator(
    /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(config) {
      var _ref2, _ref2$len, len, _ref2$timeout, timeout, _ref2$throwErr, throwErr;
        ...
        while (1) {
          switch ((_context.prev = _context.next)) {
            case 0:
              (_ref2 = config || {}),
                (_ref2$len = _ref2.len),
                (len = _ref2$len === void 0 ? 21 : _ref2$len),
                (_ref2$timeout = _ref2.timeout),
                (timeout = _ref2$timeout === void 0 ? 1500 : _ref2$timeout),
                (_ref2$throwErr = _ref2.throwErr),
                (throwErr = _ref2$throwErr === void 0 ? false : _ref2$throwErr);
                    ...
                    resolve(
                      Array(len)
                        ...
                        .map(function (_, index) {
                          return {
                            id: ''.concat(index + Math.floor(Math.random() * 100)),
                            name: 'name'.concat(index),
                            age: Math.floor(Math.random() * 100),
                            gender: 'gender'.concat(index),
                            hobby: 'hobby'.concat(index),
                            firend: 'firend'.concat(index),
                            description: 'description'.concat(index),
                            bestFirend: {
                              name: 'zhanag '.concat(index),
                              age: Math.floor(Math.random() * 100),
                            },
                          };
                        }),
