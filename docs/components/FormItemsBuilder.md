...
<code src="../../src/FormItemsBuilder/demos/demo1.tsx"  title="使用TS as 断言可以帮助我们检查 formItemChildProps 的 API 是否正确">

### 自定义布局和其他标签的使用

<code src="../../src/FormItemsBuilder/demos/demo2.tsx"  title="itemColProps 优先级高于 colProps">

### 垂直布局

<code src="../../src/FormItemsBuilder/demos/demo3.tsx"  title="itemColProps 优先级高于 colProps">
