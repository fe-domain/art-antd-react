          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(
                  'h2',
                  { id: 'formitemsbuilder-\u8868\u5355\u9879\u6784\u5efa\u5668' },
                  r.createElement(
                    l.AnchorLink,
                    {
                      to: '#formitemsbuilder-\u8868\u5355\u9879\u6784\u5efa\u5668',
                      'aria-hidden': 'true',
                      tabIndex: -1,
                    },
                ...
                r.createElement(
                  'p',
                  null,
                  'FormItemsBuilder \u7684\u76ee\u7684\u662f\u4f7f\u7528\u914d\u7f6e\u5316\u7684\u601d\u60f3\u6765\u5e2e\u52a9\u6211\u4eec\u5feb\u901f\u7684\u751f\u6210 Form.Item \u548c\u5176 Children \u7684\u6807\u7b7e\uff0c\u4f46\u5efa\u8bae\u53ea\u6709\u5fc5\u987b\u8981\u628a Form.Item \u5206\u7ec4\u4e4b\u7c7b\u7684\u573a\u666f\u65f6\u624d\u4f7f\u7528\u8be5\u7ec4\u4ef6,\u5982 ',
                  r.createElement(
                    l.AnchorLink,
                    {
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement(
                    l.AnchorLink,
                    { to: '#\u5782\u76f4\u5e03\u5c40', 'aria-hidden': 'true', tabIndex: -1 },
                    r.createElement('span', { className: 'icon icon-link' }),
                  ),
                  '\u5782\u76f4\u5e03\u5c40',
                ),
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement(
                    l.AnchorLink,
                    { to: '#\u6574\u4f53-api', 'aria-hidden': 'true', tabIndex: -1 },
                    r.createElement('span', { className: 'icon icon-link' }),
                  ),
                  '\u6574\u4f53 API',
                ),
                  ...
                  r.createElement(
                    ...
                    r.createElement(
                      ...
                      r.createElement(
                        'td',
                        null,
                        '\u5b9a\u4e49\u6bcf\u4e2a Form.Item \u548c\u5176 Child \u7684\u914d\u7f6e\uff0c\u8be6\u60c5\u89c1\u4e0b',
                      ),
                      r.createElement('td', null, 'FormItemConfig[]'),
                      r.createElement('td', null, '-'),
                    ),
                  ),
                ),
                r.createElement(
                  'h3',
                  { id: 'formitemconfig-api' },
                  r.createElement(
                    l.AnchorLink,
                    { to: '#formitemconfig-api', 'aria-hidden': 'true', tabIndex: -1 },
                    r.createElement('span', { className: 'icon icon-link' }),
                  ),
                  'FormItemConfig API',
                ),
                r.createElement(
                  ...
                  r.createElement(
                    ...
                    r.createElement(
                      'tr',
                      null,
                      r.createElement('td', null, 'key'),
                      r.createElement(
                        'td',
                        null,
                        '\u552f\u4e00\u6807\u8bc6\uff0c\u7528\u6765\u505a map \u65f6\u7684 key\uff0c\u4e0d\u5b58\u5728\u5219 name, name \u4e0d\u5b58\u5728\u65f6\u5219\u4e3a index',
                      ),
                      r.createElement('td', null, 'React.Key'),
                      r.createElement('td', null, '-'),
                    ),
                    r.createElement(
                      'tr',
                      null,
                      r.createElement('td', null, 'formItemProps'),
                      r.createElement(
                        'td',
                        null,
                        '\u540c antd \u7684 ',
                        r.createElement(
                          l.Link,
                          { to: 'https://ant-design.gitee.io/components/form-cn/#Form.Item' },
                          'Form.Item API',
                        ),
                      ),
                      r.createElement(
                    ...
                    r.createElement(
                      'tr',
                      null,
                      r.createElement('td', null, 'itemColProps'),
                      r.createElement(
                        'td',
                        null,
                        '\u540c antd \u7684 ',
                    ...
                    r.createElement(
                      'tr',
                      null,
                      r.createElement('td', null, 'renderType'),
                      r.createElement(
                        'td',
                        null,
                        '\u6807\u8bc6 Form.Item \u7684 Children \u5e94\u8be5\u4e3a \u54ea\u4e2a\u7ec4\u4ef6',
                      ),
                      r.createElement(
                        'td',
                        null,
                        r.createElement(
                          l.AnchorLink,
                          { to: '/components/form-items-builder#rendertype' },
                          '\u89c1\u5982\u4e0b RenderType \u58f0\u660e',
                        ),
                      ),
                      r.createElement('td', null, '-'),
                    ...
                    r.createElement(
                      'tr',
                      null,
                      r.createElement('td', null, 'formItemChildProps'),
                      r.createElement(
                        'td',
                        null,
                        '\u6bcf\u4e00\u9879\u5bf9\u5e94\u7684 Form.Item \u7684 children \u7684 Props\uff0c\u5982 Input \u7684 onChange \u7b49\u5c5e\u6027',
                      ),
                      r.createElement('td', null, '-'),
                      r.createElement('td', null, '-'),
                    ),
                    r.createElement(
                      ...
                      r.createElement(
                        'td',
                        null,
                        'renderType \u4e3a CustomItemChildren \u7684\u65f6\u5019 \u6e32\u67d3\u7684 Form.Item \u7684 children \u5143\u7d20',
                      ),
                    ...
                    r.createElement(
                      'tr',
                      null,
                      r.createElement('td', null, 'itemTitle'),
                      r.createElement('td', null, '\u5b9a\u4e49\u5f53\u524d\u9879\u7684 title'),
                ...
                r.createElement(
                  ...
                  r.createElement(
                    l.AnchorLink,
                    { to: '#rendertype', 'aria-hidden': 'true', tabIndex: -1 },
                    r.createElement('span', { className: 'icon icon-link' }),
                  ),
                  'RenderType',
                ),
