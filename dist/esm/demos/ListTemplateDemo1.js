...
var Demo1 = function Demo1() {
    ...
    },
    {
      ...
      render: function render(bestFirend) {
        return /*#__PURE__*/ _jsx(Tag, {
          color: 'success',
          children:
            (bestFirend === null || bestFirend === void 0 ? void 0 : bestFirend.name) || '-',
        });
      },
    },
    {
  ...
  return /*#__PURE__*/ _jsx(
    ListTemplate, // ListTemplate 的 属性继承于 Space 所以 size 就是 来自于继承的 SpaceProps
    {
      size: 16, // table 的配置
      tableProps: {
        loading: loading,
        ...
        pagination: {
          onChange: function onChange(page, pageSize) {
            console.log(
              'change pagination: pageNo = '.concat(page, ', pageSize = ').concat(pageSize),
            );
          },
        },
      }, // 包裹 Table 的 Card 的配置
